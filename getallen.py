...
"""
ONTVANG real ALS EEN REËEL GETAL
INT_DEEL = HET GEHELE DEEL VAN real
ALS real GROTER IS DAN INT_DEEL:
    GEEF INT_DEEL + 1 TERUG
ANDERS:
    GEEF INT_DEEL TERUG
"""
